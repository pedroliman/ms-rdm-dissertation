...
Neste segundo quadro, cada linha da tabela representa uma estratégia, ou seja, uma combinação única de decisões a serem simuladas em cada um dos "n" futuros plausíveis definidos.


O segundo componente 
, e neste caso específico um modelo de dinâmica de sistemas. Este componente possui todas as equações necessárias para a simulação computacional e deve ser definido de modo compatível com a biblioteca deSolve, que é utilizada para a integração numérica do modelo.
