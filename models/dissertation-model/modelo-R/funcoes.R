...
#### Funções OpenMORDM ####
# Estas funções foram retiradas do pacote open source OpenMORDM.
# Biblioteca Original: https://github.com/OpenMORDM/OpenMORDM
# As funções foram retiradas da biblioteca com o objetivo de permitir a análise.
# 
